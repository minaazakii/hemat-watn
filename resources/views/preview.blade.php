                ...
                <div class="preview_container">
                    <div class="row">
                        ...
                        <div class="col-12 title">
                           <img src="assests/img/soft_drinks.png" />
                            <span>المشروبات</span>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-6 col-sm-5 col-12 prod_details">
                            <div class="prev_data">
                                <ul class="list-unstyled">
                                    <li>
                                        <span>عصير رانى حبيبات معئة 50 مل</span>
                                    </li>
                                    <li>
                                        <span>شامل ضريبة القيمة المضافة</span>
                                    </li>
                                    <li>
                                        <i class="fas fa-seedling"></i> <span>12 نقطة  &nbsp; &nbsp;&nbsp; &nbsp; <span class="canceled">15 نقطة</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-3 col-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <i class="fas fa-seedling"></i> <span>12 نقطة 15 نقطة</span>
                                        </div>
